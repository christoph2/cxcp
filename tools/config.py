...
PARAMETERS = {
    "GENERAL": {
        "Transport-Layer": ("XCP_TRANSPORT_LAYER", {
            "CAN": "XCP_ON_CAN",
            "CAN-FD": "XCP_ON_CANFD",
            "Flexray": "XCP_ON_FLEXRAY",
            "USB": "XCP_ON_USB",
            "Ethernet": "XCP_ON_ETHERNET",
            "SxI": "XCP_ON_SXI",
            "BLE": "XCP_ON_BTH",
        }),
        "Build-Type": ("XCP_BUILD_TYPE", {"Debug": "XCP_DEBUG_BUILD", "Release": "XCP_RELEASE_BUILD"}),
        "ID #0": ("XCP_GET_ID_0", "BlueParrot XCP running on Arduino"),
        "ID #1": ("XCP_GET_ID_1", "BlueParrot_XCP_on_Arduino"),
    }, "DAQ": {
