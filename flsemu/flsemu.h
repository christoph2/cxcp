 ...
 *
 */
typedef enum tagFlsEmu_ModuleStateType { FLSEMU_UNINIT, FLSEMU_INIT } FlsEmu_ModuleStateType;
...
typedef enum tagFlsEmu_StatusType { FLSEMU_OK, FLSEMU_NOT_OK } FlsEmu_StatusType;

typedef enum tagFlsEmu_OpenCreateType { OPEN_ERROR, OPEN_EXSISTING, NEW_FILE } FlsEmu_OpenCreateResultType;
