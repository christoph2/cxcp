...
static FlsEmu_SegmentType Mock_PagedFlash = {
    "Mock_Flash", FLSEMU_KB(32), 2, FLS_SECTOR_SIZE, FLS_PAGE_SIZE, 2, 0x8000, XCP_NULL, 0, 0,
};
...
uint32_t FlsEmu_GetAllocationGranularity(void) { return 4096; }
...
void FlsMock_Init(void) { FlsEmu_Init(&FlsEmu_Config); }

void FlsMock_Deinit(void) { FlsEmu_DeInit(); }
